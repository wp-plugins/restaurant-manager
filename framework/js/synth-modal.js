...
(function($, window, document, undefined) {
    ...
    $.synthModal.prototype = {
        ...
        create_modal: function() {
            ...
            modal_html += '<div class="synth-modal-content-header"><span class="synth-modal-icon syn-iconsyntaxstudio"></span>' + title + '<a href="#close" class="synth-modal-close-event close-button"></a></div>';
        ...
        loaded: function() {
            ...
            var obj = this;
            obj.execute_load_callback();
            jQuery.synth_shortcodes.backend_modal_loaded();
        },
        save: function() {
        ...
        execute_load_callback: function() {
            ...
            if (callback_supports instanceof Array) {
                ...
                for (index in callback_supports) {
                    $.synthModal.callback_support[callback_supports[index]].call(this);
                }
            }
            if (typeof callback_supports === 'string') {
                ...
                if (index in callback) {
                    $.synthModal.callback_support[callback[index]].call(this);
                }
            }
        ...
        call_ajax_content: function() {
            ...
            jQuery.ajax({
                ...
                dataType: 'xml',
                data: {
                    action: 'synth_' + obj.options.ajax_hook,
    ...
    $.synthModal.callback_support = $.synthModal.callback_support || {};
    $.synthModal.callback_support.colorpicker = function() {

        jQuery.synth_controls.color_picker_initialize();
    };
    $.synthModal.callback_support.sortables = function() {
        modal_support_sortables();
    };
    $.synthModal.callback_support.tinymce = function() {
        modal_support_tinymce(this);
    };
    $.synthModal.callback_support.nested_element_builder = function() {

        jQuery.synth_controls.nested_shortcode_control_initialize();
    };
    $.synthModal.callback_support.table_builder = function() {

        jQuery.synth_controls.table_builder_initialize();
        //jQuery.synth_controls.shortcode_launcher_initialize();
        //jQuery('.shortcode-launch-button').ShortcodeLauncher();
    };
    $.synthModal.callback_support.tabs_builder = function() {

        jQuery.synth_controls.tabs_builder_initialize();
    };
